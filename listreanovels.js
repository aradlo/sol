...
function displayToc(filter){var numDisplayed=0;var tocTable='';var tocHead1='TITLE NOVELS';var tocTool1='Click to sort by title';var tocHead2='SHARE DATE';var tocTool2='Click to sort by date';var tocHead3='GENRE';var tocTool3='';if(sortBy=="titleasc"){tocTool1+=' (descending)';tocTool2+=' (newest first)';}
...
tocTable+='</table>';if(numDisplayed==postTitle.length){var tocNote='<span class="toc-note">Displaying all '+postTitle.length+' novels<br/></span>';}
